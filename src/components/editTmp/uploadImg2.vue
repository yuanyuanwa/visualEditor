<template>
  <div>
    {{ options }}
    {{ 111 }}
    <!-- <el-input ref="reuploadInput" type="file" accept="image/*" @change="onChange" id="fileBtn" style="display: none" /> -->
    <el-dialog v-model="dialogVisible" :title="'图片裁剪'" @close="dialogVisible = false">
      <div class="cropper">
...
const dialogVisible = ref<boolean>(true) // dialog的显示与隐藏
...
const beforeUploadEvent = (file: File) => {
  ...
  //   return item === type
  // })
  // console.log(999,props.allowTypeList,type)
  // if (!isAllowTye) {
